...
def getbloodtype(num):
    ...
    try:
        ...
        print("Choose Correct Blood Type")
        exit()
...
try:
    ...
    if options == 1:
        ...
        # Request Blood Logic
        print("You OPT for request blood to request blood you are required to donate blood of any type!")
        hospital_name = input("Enter Hospital Name: ")
        patient_name = input("Enter Patient Name: ")
        patient_age = int(input("Enter Patent Age: "))
